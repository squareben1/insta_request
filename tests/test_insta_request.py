...
class TestParse:
    ...
    def test_parse_follower(self):
        ...
        assert InstaRequest.parse_followers(self, follower_list=user_follower_object) == [
            {"test_username", "Test Tester"}]

    def test_parse_followers(self):
        """"Should return array with two names & usernames."""
        assert InstaRequest.parse_followers(self, follower_list=multi_user_follower_object) == [
            {"test_username", "Test Tester"},
